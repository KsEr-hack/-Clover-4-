# Агродрон на базе  квадрокоптера Clover 4
#####  
 # Идея проекта:
...
Агрокомпании
 ...
 # Преимущества:
 ####
 1. Снижение затрат на обработку полей за счет автоматизации и точного мониторинга.

2. Более точное внесение удобрений и пестицидов уменьшает их количество, что положительно сказывается на экологии.

3. Удобство и надежность.
