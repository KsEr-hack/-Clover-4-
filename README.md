...
# Наши шаги для достижения результата
## 23.09.24
Наша команда сформировала идею проекта. Исходя из доступных нам расходных материалов и электронных компонентов, мы определились, какие функции мы заложим в доп.нагрузку дрона (см.Функции для разработки дополнительной нагрузки) и какие задачи будут стоять перед нашей командой.

## 24.09.24
На второй день работы над проектом мы приступили к работе над прототипом узла БАС. Юмакаев Марсель спроектировал бак (доп.нагрузки) в соответствии с необходимыми техническими характеристиками к конструктиву. Ермакова Надежда запрограммировала дрон для автономного полёта и провела тестовые попытки. Sarfo Kusi разработал электросхемы для работоспособности узла. Ерчева Ксения занималась работой по написанию проекта (да, это все написано мной (: ) и участвовала в изготовлении узла БАС (3Д печать, постобработка).
В конце дня нам удалось протестировать работоспособность изготовленных систем: с насосом и с электромагнитом. Видеозаписи тестирования вы найдете в разделе "фото и видео материалы" ниже.

## 25.09.24
Наша команда занималась разработкой технической документации к  проекту.
...
![Снимок экрана 2024-09-26 134306](https://github.com/user-attachments/assets/e7273f53-bf94-493e-9bb0-36fdae01bc0c)
